...
First we note that we have a sample that does not exist in landings. One single trawl-sample, that we have defined out of the population to estimate. We will remove this:
...
nFish$count <- nFish$SAtotalWtLive / samples$meanweight
...
```{r}
recaResult <- runRECA(recaObj, nSamples=500, burnin = 500)
```
